...
//                                 <img src={category.icon} alt={category.title} className="w-8 h-8 mr-2" />
//                                 {category.title}
//                             </CardTitle>
//                         </CardHeader>
//                         <CardContent>
...
//                                                     <div key={subCategory._id} className="flex justify-between items-center mb-2">
//                                                         <span>{subCategory.title}</span>
//                                                         <Button variant="destructive" size="sm" onClick={() => handleDeleteSubCategory(subCategory._id)}>
//                                                             Delete
//                                                         </Button>
//                                                     </div>
//                                                 ))}
