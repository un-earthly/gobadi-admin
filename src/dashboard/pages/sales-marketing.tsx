...
export default function SalesMarketingManagement() {
    ...
    const handleAddCampaign = () => {
        ...
        setNewCampaign({
            id: 0, // Reset id to avoid conflicts
            name: "",
            type: "banner",
            content: "",
            image: "",
    ...
    const handleImageUpload = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (file) {
            ...
            reader.onloadend = () => {
                ...
                if (editingCampaign) {
                    setEditingCampaign({ ...editingCampaign, image: result });
                } else {
                    setNewCampaign({ ...newCampaign, image: result });
                }
            };
                                    ...
                                    <div className="grid gap-4 py-4">
                                        ...
                                        <div className="grid grid-cols-4 items-center gap-4">
                                            ...
                                            <Select
                                                ...
                                                onValueChange={(value) => editingCampaign ? setEditingCampaign({
                                                    ...editingCampaign, type: value as "banner" | "popup"
                                                }) : setNewCampaign({
                                                    ...newCampaign, type: value as "banner" | "popup"})}
                                            >
