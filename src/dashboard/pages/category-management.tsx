...
export default function CategoryManagement() {
    ...
    const [isAddingCategory, setIsAddingCategory] = useState<any>(false)
    const [isEditingCategory, setIsEditingCategory] = useState<any>(false)
    const [isManagingSubCategories, setIsManagingSubCategories] = useState<any>(false)
    const [newCategoryTitle, setNewCategoryTitle] = useState<any>('')
    const [newCategoryImage, setNewCategoryImage] = useState<any>(null)
    const [newSubCategoryTitle, setNewSubCategoryTitle] = useState<any>('')
    const [editingSubCategory, setEditingSubCategory] = useState<any>(null)
    const [editSubCategoryTitle, setEditSubCategoryTitle] = useState<any>('')
    useEffect(() => {
        fetchCategories()
    }, [])
